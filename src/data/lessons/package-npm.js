export const lesson = {
  ...
  meta: '工程 · v18+',
  version:
    '旧项目常把 package.json 当成“能 npm install 就行”的清单；现代 Node 项目要理解 scripts、dependencies、devDependencies、engines、exports、lockfile 和 npm ci 的协作。Node v20/v22/v24 项目都应把可重复安装和发布边界作为基础工程能力。',
